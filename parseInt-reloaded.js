function parseInt(string) {
  ...
  for (let i = 0; i < numberArray.length; i++) {
    console.log(typeof translateToNumber(numberArray[i]));
    if (translateToNumber(numberArray[i]) === null) result.push(translateToNumber(numberArray[i - 1]) * multiMap[numberArray[i]]);
